...
@section('content')
    ...
    <!--============================
        BANNER PART 2 START
    ==============================-->
    @include('frontend.ecommerce.home.sections.banner-slider')
    <!--============================
        BANNER PART 2 END
    ==============================-->
    ...
    <!--============================
        FLASH SELL START
    ==============================-->
    @include('frontend.ecommerce.home.sections.flash-sale')
    <!--============================
        FLASH SELL END
    ==============================-->
    ...
    ==============================-->
    @include('frontend.ecommerce.home.sections.top-category-product')
    <!--============================
    ...
    <!--============================
        BRAND SLIDER START
    ==============================-->
    @include('frontend.ecommerce.home.sections.brand-slider')
    <!--============================
        BRAND SLIDER END
    ==============================-->
    ...
    <!--============================
        SINGLE BANNER START
    ==============================-->
    @include('frontend.ecommerce.home.sections.single-banner')
    <!--============================
        SINGLE BANNER END
    ==============================-->
    ...
    <!--============================
        HOT DEALS START
    ==============================-->
    @include('frontend.ecommerce.home.sections.hot-deals')
    <!--============================
        HOT DEALS END
    ==============================-->
    ...
    ==============================-->
    @include('frontend.ecommerce.home.sections.category-product-slider-one')
    <!--============================
        ELECTRONIC PART END
    ==============================-->
    ...
    <!--============================
        ELECTRONIC PART START
    ==============================-->
    @include('frontend.ecommerce.home.sections.category-product-slider-two')
    <!--============================
        ELECTRONIC PART END
    ==============================-->
    ...
    <!--============================
        LARGE BANNER  START
    ==============================-->
    @include('frontend.ecommerce.home.sections.large-banner')
    <!--============================
        LARGE BANNER  END
    ==============================-->
    ...
    ==============================-->
    @include('frontend.ecommerce.home.sections.weekly-best-item')
    <!--============================
    ...
    <!--============================
      HOME SERVICES START
    ==============================-->
    @include('frontend.ecommerce.home.sections.home-service')
    <!--============================
        HOME SERVICES END
    ==============================-->
    ...
    <!--============================
        HOME BLOGS START
    ==============================-->
    @include('frontend.ecommerce.home.sections.blog')
    <!--============================
        HOME BLOGS END
    ==============================-->
@endsection
